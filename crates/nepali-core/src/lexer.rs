...
impl Lexer {
    ...
    fn read_identifier(&mut self, loc: Location) -> Token {
        ...
        let (token_type, bool_val) = match s.as_str() {
            "राखौँ" | "राखौं" | "राखौ" | "rakha" | "rakhau" | "rakhaun" => (TokenType::Let, None),
            "काम" | "kaam" => (TokenType::Function, None),
            "यदि" | "yadi" => (TokenType::If, None),
            "भए" | "भने" | "bhaye" | "bhane" => (TokenType::Then, None),
            "नत्र" | "अथवा" | "natra" | "athawa" | "athwa" => (TokenType::Else, None),
            "भएसम्म" | "जबसम्म" | "bhayesamma" | "jabasamma" => (TokenType::While, None),
            "पठाउँ" | "पठाउं" | "पठाउ" | "पठाऔँ" | "पठाऔं" | "pathau" | "pathaun" => (TokenType::Return, None),
            "भनौँ" | "भनौं" | "भनौ" | "लेख्नुहोस्" | "छाप्नुहोस्" | "bhana" | "bhanau" | "bhanaun" | "lekhnuhos" | "chhapnuhos" => (TokenType::Print, None),
            "सहि" | "सही" | "साँचो" | "साँच्चै" | "sahi" | "saanchai" => (TokenType::True, Some(true)),
            "गलत" | "झूट" | "झुट" | "galat" | "jhoot" | "jhut" => (TokenType::False, Some(false)),
            "केहीछैन" | "शून्य" | "kehichaina" | "shoonya" | "shunya" => (TokenType::Null, None),
