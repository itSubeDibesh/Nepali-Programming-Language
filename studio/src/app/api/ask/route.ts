...
function resolveLocalModel(): { model: string; tokenizer: string } | null {
  ...
  const candidates: Array<[string, string]> = [
    ...
    [path.resolve(process.cwd(), '../models/llm/model.gguf'), path.resolve(process.cwd(), '../models/llm/tokenizer.json')],
    [path.resolve(process.cwd(), 'models/llm/model.gguf'), path.resolve(process.cwd(), 'models/llm/tokenizer.json')],
    [path.resolve(process.cwd(), '../../Resources/models/llm/model.gguf'), path.resolve(process.cwd(), '../../Resources/models/llm/tokenizer.json')],
