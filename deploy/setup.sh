...
cargo build --release --manifest-path crates/nepali-core/Cargo.toml --bin nepali-core-cli --features ai-interop,python-interop,rust-interop,js-interop,cache,studio,db
